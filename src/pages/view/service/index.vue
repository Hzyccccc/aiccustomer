            ...
            <div class="table-wrapper">
              ...
              <div class="content-hzy" v-for="(item,i) in mainList" :key="i">
                <div>
                  ...
                  <div class="content-right-hzy">
                    ...
                    >服务内容: {{item.sys_content}}</div>
                    <div class="content-footer-hzy">加入关注时间：{{item.focus_time}}</div>
              ...
              <el-dialog
                ...
                >
                  ...
                  <el-form-item label="服务内容：" style="margin-top:-20px">
                    <span>{{contenList.sys_content}}</span>
                  </el-form-item>
              ...
              <el-dialog
                ...
                >
                  ...
                  <el-form-item label="服务内容：" style="margin-top:-20px">
                    <p :title="contenList.sys_content" style="overflow:hidden;text-overflow:ellipsis;white-space: nowrap;height:30px;">{{contenList.sys_content}}</p>
                  </el-form-item>
                  <el-form-item label="订阅服务：" prop="checkList">
                    <el-checkbox-group
  ...
  methods: {
    ...
    textMen() {
      if (this.ruleForm.callbackUrl === "") {
        ...
        this.axios
          .post(this.ruleForm.callbackUrl, {})
          .then(res => {
