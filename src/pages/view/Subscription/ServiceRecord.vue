          ...
          <el-card>
            <div class="table-wrapper">
              ...
              >
                ...
                <el-table-column label="推送日期" prop="push_date" align="center"></el-table-column>
                <el-table-column label="推送时间" prop="push_time" align="center"></el-table-column>
                <el-table-column label="推送状态" prop="dic_name" align="center"></el-table-column>
                <el-table-column label="返回代码" prop="return_code" align="center"></el-table-column>
                <el-table-column label="上传数据大小(字节)" prop="size" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    requestList() {
      ...
      this.axios
        .post("/cssPush/findByStatusAndTime", {
